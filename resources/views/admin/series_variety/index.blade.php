    ...
    <form action="{{ url('/admin/master-database/seriesVariety/'.$srv->id) }}" method="POST" id="quickForm{{ $srv->id }}">
      ...
      <div class="modal-body">          
          <div class="form-group">
            ...
            <input type="name" id="series_variety_name{{ $srv->id }}" name="series_variety_name" value="{{ $srv->series_variety_name }}" class="form-control" aria-describedby="emailHelp" placeholder="Insert series variety name" >
          </div>
